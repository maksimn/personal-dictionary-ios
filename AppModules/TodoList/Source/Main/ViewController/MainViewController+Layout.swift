...
extension MainViewController {
    ...
    func layout(toggableItemListView: UIView) {
        view.addSubview(toggableItemListView)
        toggableItemListView.snp.makeConstraints { make -> Void in
    ...
    func layout(_ navToItemEditorBuilder: NavToItemEditorBuilder) {
        let navToItemEditorView = navToItemEditorBuilder.build()

        view.addSubview(navToItemEditorView)
        navToItemEditorView.snp.makeConstraints { make -> Void in
